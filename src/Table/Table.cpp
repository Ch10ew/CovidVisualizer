...
void co::TableTotalConfirmed()
{
    ...
    std::map<std::string, long> data = CalculateTotal();
...
void co::TableHighestLowestDeath()
{
    ...
    std::map<std::string, std::pair<long long, long long>> data = co::CalculateHighestLowestDeath();
...
void co::TableHighestLowestRecovered()
{
    ...
    std::map<std::string, std::pair<long long, long long>> data = co::CalculateHighestLowestRecovered();
